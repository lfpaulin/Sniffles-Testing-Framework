...
# from benchmarks.pipelines import *
...
# full benchmark, both ONT and HiFi
def full_bench(user_args):
    # Start-up
    sleep_sec = user_args.sleep_sec
    ...
    # NOTE: Mosaic => use HapMap, TODO
    my_logger.info("Mosaic => use HapMap.. WiP")
    time.sleep(sleep_sec)
    ...
    # # TODO: update
    my_logger.warning("Larger DUP/DEL ONT sim")
    ont_large_deldup_params = ONTLargeDelDupParams()
    ont_large_deldup_params.set_parameters_from_json(params_json["large_deldup_ont"], base_dir, data_dir, snf2_pub, snf2_dev)
